...
### 🛠️ Stack Técnico
- **Lenguajes:** Python (Automatización/Data), C++ (Algoritmos/Estructuras), JavaScript (Web).
- **Web:** Creación de Landing Pages optimizadas, despliegue en Netlify y gestión de dominios.
